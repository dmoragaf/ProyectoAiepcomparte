...
/*
    ...
    $_SESSION['datoCorreo'] = $_SESSION['datoCorreo'];
    echo  "<br><br><br><br>Usuario conectado: ".$_SESSION['datoNom']." ".$_SESSION['datoApe'];
    echo "<br><br>Correo: ".$_SESSION['datoCorreo'];
}*/
?>
